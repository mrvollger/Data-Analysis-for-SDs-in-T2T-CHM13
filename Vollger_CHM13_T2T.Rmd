...
#
#
g_fish_imgs = ggdraw() + draw_image("FISH/FES_FISHRESULTS_GM24385_LM new.png")
...
figure = plot_grid(flat_duplicon,
                   plot_grid(
                            g_fish_imgs,
                            p_duplicons,
                             labels = c("b","c"),
...
#figure
ggsave("figures/Duplicons.pdf", plot=figure , width=20, height=12) 
